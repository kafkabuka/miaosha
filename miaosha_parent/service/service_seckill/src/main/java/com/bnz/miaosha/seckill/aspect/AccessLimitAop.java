package com.bnz.miaosha.seckill.aspect;
...
public class AccessLimitAop {
    ...
    @Pointcut("@annotation(com.bnz.miaosha.seckill.aspect.AccessLimit)")
    public void limit(){}
    ...
    public Object around(ProceedingJoinPoint proceedingJoinPoint){
        ...
        if (flag){
            ...
            //不允许访问,拒绝
            String errorMessage = JSON.toJSONString(Result.error(CodeMsg.ACCESS_ERROR));
            //将信息返回到客户端上
